...
public class HomeActivityRecyclerAdapter extends RecyclerView.Adapter<HomeActivityRecyclerAdapter.MyViewHolder> {
    ...
    void deleteItem(int index, CardView cardView, int calledFrom) {
        setAnimation(calledFrom, cardView);
    ...
    private void setAnimation(int calledFrom, CardView cardView) {

        Animation animation;
        if(calledFrom == 0){
            animation = AnimationUtils.loadAnimation(activity, animationUtil.returnSlideToRightAnimation());
        }else {
            animation = AnimationUtils.loadAnimation(activity, animationUtil.returnSlideToLeftAnimation());
        }
